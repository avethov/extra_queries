...
Redmine::Plugin.register :extra_queries do
  ...
  Rails.application.config.to_prepare do
    require 'redmine/query_association_column'
    ...
    unless TimeEntryQuery.included_modules.include?(ExtraQueries::TimeEntryQueryPatch)
      TimeEntryQuery.send(:include, ExtraQueries::TimeEntryQueryPatch)
    end
    ...
    unless SortHelper.included_modules.include?(ExtraQueries::SortHelperPatch)
      SortHelper.send(:include, ExtraQueries::SortHelperPatch)
    end
  end

  Rails.application.config.after_initialize do
    plugins = { a_common_libs: '2.1.9', global_roles: '2.2.0' }
